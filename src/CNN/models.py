...
from networks import  Colorization_Network, Classification_Network, Low_Level_Features, Mid_Level_Features, Colorization_Layers
...
class Only_Classification_Model(tf.keras.Model):
    def __init__(self, no_of_classes, optimizer, loss_function_category):
        super().__init__()
        self.low_level = Low_Level_Features()        
        self.classification_model = Classification_Network(self.low_level, no_of_classes)
